...
rod to stay within our offset shell using a simple penalty force. \changes{This approach can successfully route pipes through complex geometries (Figure \ref{fig:complex}).}
...
Pipes are routed and cut out of the mesh serially. \changes{This prevents pipe intersections: once a pipe has been cut out of the mesh, it cannot be part of valid routes in any future pipe routing operation (Figure~\ref{fig:complex}c)}. After solving for a path, we add it as a constraint to the system, generating
...
%Our plane cut option goes towards this, however a more advanced tool for this purpose is outside the scope of this work.
