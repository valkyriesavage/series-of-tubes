...
\bjoern{We should be careful with our terminology - apparently pipes and pipes have different connotations. Pipes are measured by outer diameter (OD) and tend to be structural, while pipes are measured by inside diameter (ID) and tend to be used to transport media inside them. At the least, we should mention that different communities have these different connotations. I think that in our case, we're thinking mostly of the 3D print as the structural object that we're then tunneling through with {\em pipes}.}
