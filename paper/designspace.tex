...
\emph{Open} pipes may be used to create electronic circuitry.  For example, an open pipe filled with conductive paint and connected to a battery can power an LED (Figure \ref{fig:openings}a).
%
