...
\valkyrie{Reference those pages from Bjoern:

http://ttb.com/recent-news/diagrams/

We can talk about wall thickness, tangent length, degree of bend, arg bend angle, inner and outer diameters, centerline radius, etc.}
