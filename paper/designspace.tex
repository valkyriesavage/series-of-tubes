...
Open pipes originate from the system side and connect the user side, with both ends of the pipe open. This type of pipe may be used to create electronic circuitry.  An open pipe filled with conductive paint can power an LED (see Figure \ref{fig:openings}A).
...
Semi-closed pipes are open on the system side, closed on the user side.  The closed interface may be fabricated from a malleable material, e.g., a rubber membrane, and attached to a fluid pump to create haptic feedback (see Figure \ref{fig:openings}C).
