...
\toappear{Waiting for final copyright text from ACM/Sheridan.}
...
\title{A Series of Tubes: Adding Interactivity to\\ 3D Prints Using Internal Pipes}
...
\author{
  ...
  \alignauthor $\dagger$ Autodesk Research \\
             $\star$ UC Berkeley EECS \\
}
...
\centering
    ...
    \caption{A collection of interactive objects designed using our tool.  All have electronic sensing or actuation components routed through their \emph{interior}.  Left: a radio, haptic feedback rabbit, maze, and presence-aware pen holder.  Center: touch-sensitive toys.  Right: custom neon signs.}
