...
\toappear{In preparation for submission to UIST 2014.}
...
\centering
    ...
    \caption{A collection of interactive objects designed using our tool.  All have electronic sensing or actuation components routed through their \emph{interior}.  In (a), objects printed on a hobbyist 3D printer.  In (b), those manufactured on industrial-grade printers. \bjoern{size this so the ``Introduction'' heading is at the top of column 2} \bjoern{It's hard to tell what these objects *do* and how they are different from normal 3D-printed objects without pipes. May need photos of the objects ``in action''.}}
