...
void setup() {                
  ...
  pinMode(A0, INPUT); //Trimpot for analog station control
  pinMode(A1, INPUT); //Trimpot for analog volume control
...
void loop() {
  ...
  while(1) {
    ...
    trimpot = map(trimpot, 0, 674, 875, 1079); //Convert the trimpot value to a valid station
